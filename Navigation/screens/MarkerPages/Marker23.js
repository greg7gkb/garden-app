...
const text = 
    <Text style={{ padding: 20, paddingBottom: 37, fontFamily: "Times New Roman", fontSize: 20 }}>   
        ...
        from the bark of the <Text style={{fontWeight: "bold"}}><Text style={{fontStyle:"italic"}}>Parkinsonia</Text> 'Desert Museum' (Palo Verde)</Text> with its tiny textured leaves, 
...
const directions = <Text style={{ padding: 20, fontFamily: "Times New Roman", fontSize: 20 }}>Walk to the very end of the covered-structure. The mound caddy corner to the covered bed holds Marker 24.  </Text>
