...
const popUpText = 
    <Text style={{padding: 15, fontFamily: "Times New Roman", fontSize: 20}}>
        Like dyckias, mangaves have unique coloring, including combinations of red, brown, white, and purple.     
    </Text> 
...
export default function MarkerScreen({ navigation }) {
    return (
        <Marker images={images} num={13} text={text} popUpText={popUpText} navigation={navigation} map={map} directions={directions}></Marker>
    );
}